package algorithm2023.jul.day20;
...
public class G5_BOJ21610_0720 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < M; i++) {
			...
			//구름이 이동하면서 기존 구름을 건드리지 않도록 배열 하나 추가로 선언
	...
	static void moveCloud() {
		...
		//물이 2보다 많은 곳은 비구름 생성 및 물 양 2 감소, 구름이 있던 자리 제외하고 구름 생성
		for (int y = 0; y < N; y++) {
			for (int x = 0; x < N; x++) {
				if (map[y][x] >= 2) {
					if (nextCloud[y][x] == 0) {
